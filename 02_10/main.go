...
// // (urlfetch) Принимает в качестве аргументов список урлов, 
// // делает запросы к этим урлам и печатает в стдаут то, что она скачала
// import (
// 	"net/http"
// 	"fmt"
// 	"os"
...
// // смысл этой функции: когда в ваш сервер прилетит запрос - будет вызвана эта функция
// // И эта функция посмотрит на запрос, который записан в переменной Request, и должна сформировать ответ
// // и записать этот ответ в ResponseWriter. 
// // ResponseWriter можно использовать как Stdout: в него можно помещать ответ
// // Здесь в него просто записывается путь, по которому был сделан запрос
